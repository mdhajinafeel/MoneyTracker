...
@AndroidEntryPoint
public class WalletArchivedActivity extends BaseActivity {

    private AppCompatImageView icBack;
    private AppCompatTextView tvArchivedWallets, tvSorting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archived_wallets);
        statusBarSetting();
        hideKeyboard(this);
        initComponents();
    }
        ...
        try {
            walletAdapter = new RecyclerViewAdapter<>(this, new ArrayList<>(), R.layout.item_wallet_manage) {
                ...
                public void onPostBindViewHolder(ViewHolder holder, WalletEntity wallet) {
                    ...
                    AppCompatTextView tvWalletArchiveBadge = holder.getView(R.id.tvWalletArchiveBadge);
                    ...
                    ivWalletIcon.setImageDrawable(ContextCompat.getDrawable(WalletArchivedActivity.this, walletIcon));
                    ...
                    tvWalletArchiveBadge.setText(getString(R.string.archived_on, DateHelper.getFormattedDate(wallet.archivedAt, "dd MMM yy")));

                    holder.getView(R.id.tvWalletBadge).setVisibility(View.GONE);
                    holder.getView(R.id.tvWalletArchiveBadge).setVisibility(View.VISIBLE);
                    CommonUtils.setDrawable(WalletArchivedActivity.this, holder.getView(R.id.tvWalletArchiveBadge), R.drawable.ic_calendar_archive,
                            R.dimen.icon_10, R.color.transfer, Gravity.START);
    ...
    private void observeData() {
        try {
            walletViewModel.getArchivedWallets().observe(this, wallets -> {
                if (wallets == null || wallets.isEmpty()) {
                    ...
                    tvArchivedWallets.setText(getResources().getQuantityString(R.plurals.wallet_count, count, count));
                }
            });
        } catch (Exception e) {
    ...
    private void showOptionDialog(WalletEntity wallet) {
        try {
            BottomSheetDialog dialog = new BottomSheetDialog(WalletArchivedActivity.this);
            ...
            ivTransactionIcon.setImageDrawable(ContextCompat.getDrawable(WalletArchivedActivity.this, walletIcon));
            ...
            optionEdit.setOnClickListener(v -> {
                dialog.dismiss();
                startActivity(new Intent(WalletArchivedActivity.this, CreateWalletActivity.class)
                        .putExtra("isEdit", true)
                        .putExtra("walletId", wallet.id));
                ActivityUtils.overrideOpenTransition(WalletArchivedActivity.this, R.anim.top_to_bottom, R.anim.scale_out);
            });
            ...
            optionViewDetails.setOnClickListener(v -> {
                dialog.dismiss();
                startActivity(new Intent(WalletArchivedActivity.this, WalletTransactionDetailedActivity.class)
                        .putExtra("walletId", wallet.id)
    ...
    private void showRestoreDialog(WalletEntity wallet) {
        ...
        headerImage.setImageDrawable(ContextCompat.getDrawable(WalletArchivedActivity.this, R.drawable.ic_refresh));
        headerImage.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(WalletArchivedActivity.this, R.color.primary_dark)));
        tvDelete.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(WalletArchivedActivity.this, R.color.primary_dark)));
    ...
    private void showDeleteTransactionDialog(WalletEntity wallet) {
        ...
        cardHeader.setCardBackgroundColor(getColor(R.color.light_lavender));
        headerImage.setImageDrawable(ContextCompat.getDrawable(WalletArchivedActivity.this, R.drawable.ic_data_delete_outline));
        headerImage.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(WalletArchivedActivity.this, R.color.primary_dark)));
        tvCancel.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(WalletArchivedActivity.this, R.color.primary_dark)));
