...
public class IncomeCategoryFragment extends Fragment {
    ...
    private RecyclerViewAdapter<CategoryEntity> incomeCategoryAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            categoryViewModel.incomeCategory(TransactionEntity.TYPE_INCOME, false);
            ...
            categoryViewModel.getIncomeCategories().observe(requireActivity(), categoryEntities -> {
                ...
                if (incomeCategoryAdapter == null) {
                    ...
                    incomeCategoryAdapter.replaceItems(categoryEntities);
                }
    ...
    private void bindIncomeCategories(List<CategoryEntity> incomeCategories) {
        try {
            incomeCategoryAdapter = new RecyclerViewAdapter<>(requireActivity(), incomeCategories,
                    R.layout.item_manage_category) {
                @Override
        ...
        if (count == 0) {
            btnDelete.setOnClickListener(v -> {
                ...
                if (categoryViewModel.deleteCategory(selectedCategoryId)) {
                    incomeCategoryAdapter.removeItem(selectedCategoryPosition);
    ...
    private void showCategoryOptionDialog(int count) {
        try {
            ...
            categoryViewModel.getCategoriesForMove(TransactionEntity.TYPE_INCOME, selectedCategoryId);
