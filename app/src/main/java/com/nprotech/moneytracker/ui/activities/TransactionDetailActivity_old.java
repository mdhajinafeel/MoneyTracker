...
@AndroidEntryPoint
public class TransactionDetailActivity_old extends BaseActivity {
    ...
    private void setupListeners() {
        try {
            ...
            ivEdit.setOnClickListener(view -> {
                ...
                intent.putExtra("transactionId", transactionWithDetails);
            ...
            getOnBackPressedDispatcher().addCallback(
                    ...
                    new OnBackPressedCallback(true) {
                        ...
                        public void handleOnBackPressed() {
                            finish();
                            ActivityUtils.overrideCloseTransition(TransactionDetailActivity_old.this, R.anim.scale_in, R.anim.right_to_left);
                        }
                    });
        } catch (Exception e) {
