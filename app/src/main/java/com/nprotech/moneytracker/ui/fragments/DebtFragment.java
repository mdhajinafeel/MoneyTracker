...
public class DebtFragment extends Fragment {
    ...
    private RecyclerViewAdapter<DebtLoanEntity> debtAdapter;
    ...
    private void bindData() {
        try {
            debtLoanViewModel.getAllDebtLoans(DebtLoanType.BORROW).observe(getViewLifecycleOwner(), debtLoans -> {
               if(debtLoans.isEmpty()) {
                   ...
                   debtAdapter.setItems(debtLoans);
               }
            });
        } catch (Exception e) {
    ...
    private void initializeAdapter() {
        try {
            ...
            debtAdapter = new RecyclerViewAdapter<>(requireActivity(), new ArrayList<>(), R.layout.item_debt_loan_detail) {
                @Override
            ...
            rvDebtLoans.setAdapter(debtAdapter);
