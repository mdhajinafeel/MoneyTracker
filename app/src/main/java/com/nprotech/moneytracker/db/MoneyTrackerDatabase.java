...
@Database(entities = {CurrencyEntity.class, CategoryEntity.class, AccountEntity.class, WalletEntity.class, TransactionEntity.class, TransactionAttachmentEntity.class},
        version = 1)
